...
public class OpcNuevoAdmin extends OpcionDeMenu {

	public OpcNuevoAdmin(String key){
		super(key);
	}
	...
	public void ejecutar() {
		...
		Administrador.crearAdministrador(name,cc,tel,"Operario", username, email, password,sue,lugar);
	}
